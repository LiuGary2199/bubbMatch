                        ...
                        for(int i = 0; i < atlasYCount; i++)
                        {
                            for(int j = 0; j < atlasXCount; j++)
                            {
                                ...
                                for(int y = 0; y < textureYTargetHeight; y++)
                                {
                                    ...
                                    {
                                        if(hasImageForThisIndex) newAtlas.SetPixel((j * textureXTargetWidth) + x, (atlasHeight - i * textureYTargetHeight - textureYTargetHeight) + y, AtlasCopy[currIndex].GetPixel(x, y));
                                        else newAtlas.SetPixel((j * textureXTargetWidth) + x, (atlasHeight - i * textureYTargetHeight - textureYTargetHeight) + y, new Color(0, 0, 0, 1));
                                    }
                                }
                            }
                        }
