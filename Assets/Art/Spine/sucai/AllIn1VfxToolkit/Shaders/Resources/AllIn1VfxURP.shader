Shader "AllIn1Vfx/AllIn1VfxURP"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            sampler2D _DistNormalMap, _GrabTexture, _CameraSortingLayerTexture;
            ...
            half4 frag(v2f i) : SV_Target
            {
            	...
            	half3 distortCol = tex2D(_CameraSortingLayerTexture, i.screenCoord.xy);
            	#if DISTORTONLYBACK_ON
            	...
            	col.rgb = lerp(lerp(col.rgb, saturate(distortCol.rgb), _DistortionBlend), lerp(col.rgb, tex2D(_CameraSortingLayerTexture, (originalScreenCoord / originalScreenCoord.w).xy).rgb, _DistortionBlend), frontMask);
            	#else
